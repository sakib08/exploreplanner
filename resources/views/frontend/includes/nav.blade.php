<nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
        <ul class="navbar-nav">
            ...
            @auth
                <li class="nav-item"><a href="{{route('user.user.dashboard')}}" class="nav-link {{ active_class(Active::checkRoute('user.user.dashboard')) }}">{{ __('navs.frontend.dashboard') }}</a></li>
            @endauth
            ...
            @else
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuUser">
                        ...
                        <a href="{{ route('user.user.account') }}" class="dropdown-item {{ active_class(Active::checkRoute('user.user.account')) }}">{{ __('navs.frontend.user.account') }}</a>
